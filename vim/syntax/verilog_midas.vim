" File copied from: /usr/share/vim/vim72/syntax/verilog.vim
" Extended to SystemVerilog and Midas
...
syn keyword verilogStatement   logic inside unique break
syn keyword verilogStatement   type typedef union package endpackage enum
syn keyword verilogStatement   assume assert
...
" do not completely highlight strings as they can contain Verilog statements
...
" Midas syntax (overwrite verilog ones):
" - Midas keywords (from generic jinja/phyton syntax)
"   potentially connflicting with verilog keywords
syn match   midasSpecial "%%" nextgroup=midasKeyword skipwhite
syn match   midasSpecial "{%" nextgroup=midasKeyword skipwhite
syn match   midasSpecial "%}"
" - content of strings can be Verilog, just highlight string quotes 
syn match   midasSpecial "\""
syn keyword midasKeyword for
syn keyword midasKeyword endfor
syn keyword midasKeyword if
syn keyword midasKeyword elif
syn keyword midasKeyword else
syn keyword midasKeyword endif
syn keyword midasKeyword in
" - Midas keywords (macros)
syn keyword midasMacro addition
syn keyword midasMacro and_or_tree
syn keyword midasMacro and_reduction
syn keyword midasMacro decreasing_prio
syn keyword midasMacro dff
syn keyword midasMacro increasing_prio
syn keyword midasMacro older
syn keyword midasMacro oldest
syn keyword midasMacro or_reduction
syn keyword midasMacro select
syn keyword midasMacro select_onehot
syn keyword midasMacro select_priority
syn keyword midasMacro sva_preamble sva_postamble
syn keyword midasMacro validation endvalidation
syn keyword midasMacro vectorize
syn keyword midasMacro xor_reduction
syn keyword midasMacro youngest
syn keyword midasMacro vinclude endvinclude
syn keyword midasMacro instrid endinstrid
syn keyword midasMacro tarmac endtarmac
" - Midas comment
syn match   midasComment "\v\%\!.*"
...
if version >= 508 || !exists("did_verilog_syn_inits")
   ...
   " New highlights 
   HiLink midasMacro             StorageClass
   HiLink midasKeyword           StorageClass
   HiLink midasComment           Comment
   HiLink midasSpecial           Special
